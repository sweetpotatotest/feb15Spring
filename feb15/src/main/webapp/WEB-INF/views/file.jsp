...
<title>Trinity Company - FFFile</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<!-- 파일 업로드 -->
	<section class="page-section bg-light" id="file">
		<div class="container">
		<button onsubmit="check()">11</button>
			<div class="input-group">
				<form action="./file" method="post" enctype="multipart/form-data" onsubmit="fileCheck()">
				<input type="file" accept="image/*" name="file1" class="form-control" id="inputGroupFile04"
					aria-describedby="inputGroupFileAddon04" aria-label="Upload">
				<button class="btn btn-outline-secondary" type="submit"
					id="inputGroupFileAddon04">어업로드</button>
				</form>
			</div>
		</div>
	</section>
